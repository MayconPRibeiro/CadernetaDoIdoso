...
def tipoCadastro():
    if request.method == 'POST':
        ...
        if this.tipoCadastramento == "Idoso":
            return render_template('cadastroIdoso.html')
        else:
            return render_template('cadastroCuidador.html')
...
def cadastrarIdoso():
    if request.method == 'POST':
            ...
            this.cidadeDeNascimento = request.form['tNovoCidadeDeNascimento']
            ...
            this.dataCadastrada = request.form['tDataCadastrada']
