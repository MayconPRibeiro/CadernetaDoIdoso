...
class model:
    ...
    def inserirIdoso(self, cpf, nome, dataDeNascimento, cidadeDeNascimento, racaCor, moradia, cartaoSus, pai, mae, sabeLerEscrever, escolaridade, rua, cidade, bairro, numero, cep, municipio, estado, complemento, telefone, email, estacaoConjugal, profissao, convenio, deficiencia, tipoSanguineo, fatorRH, nomeResponsavel, vinculoResponsavel, telefoneResponsavel, enderecoResponsavel, moraResponsavel, dataCadastrada):
        try:
            ...
            sql = "insert into cadastro(cpf, nome, dataDeNascimento, cidadeDeNascimento, racaCor, moradia, cartaoSus, pai, mae, sabeLerEscrever, escolaridade, rua, cidade, bairro, numero, cep, municipio, estado, complemento, telefone, email, estacaoConjugal, profissao, convenio, deficiencia, tipoSanguineo, fatorRH, nomeResponsavel, vinculoResponsavel, telefoneResponsavel, enderecoResponsavel, moraResponsavel, dataCadastrada) values('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}','{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}');".format(cpf, nome, dataDeNascimento, cidadeDeNascimento, racaCor, moradia, cartaoSus, pai, mae, sabeLerEscrever, escolaridade, rua, cidade, bairro, numero, cep, municipio, estado, complemento, telefone, email, estacaoConjugal, profissao, convenio, deficiencia, tipoSanguineo, fatorRH, nomeResponsavel, vinculoResponsavel, telefoneResponsavel, enderecoResponsavel, moraResponsavel, dataCadastrada)
            self.con.execute(sql)
